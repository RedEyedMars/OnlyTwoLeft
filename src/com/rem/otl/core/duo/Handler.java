...
/**
 * See {@link com.rem.otl.core.duo.client.Client} for more details on the client/handler relationship
 ...
 * Receives {@link com.rem.otl.core.duo.messages.Message}'s and runs them.
 ...
 * 
 * @see com.rem.otl.core.duo.client.Client Client
 * @author Geoffrey
 *
 */
public class Handler {
	...
	/**
	 * Basic Constructor.
	 * @param client - host {@link com.rem.otl.core.duo.client.Client}, the {@link com.rem.otl.core.duo.client.Client} which control's this handler.
	 */
	...
	/**
	 * Called by the {@link com.rem.otl.core.duo.messages.MeetMeAtPortMessage}, which proves the Server port which this handler will do future communications through.
	 ...
	 * @return boolean, true if this handler can accept/receive {@link com.rem.otl.core.duo.messages.Message}'s, false otherwise.
	 */
	...
	/**
	 * Used by the {@link com.rem.otl.core.duo.messages.EndConnectionMessage} to shut down this client/handler.
	 */
	public void close(){
	 ...
	 * @param message - {@link com.rem.otl.core.duo.messages.Message} to send before anything else.
	 */
	...
	/**
	 * Thread which collects incoming messages to this handler and calls the {@link com.rem.otl.core.duo.messages.Message}.act method.
	...
	private class HandlerInputThread extends Thread{
		...
		/**
		 * While the handler is connected reads incoming messages from the Server/partner {@link com.rem.otl.core.duo.client.Client}.
		 */
		@Override
		public void run(){
	...
	/**
	 * Standard method to send {@link com.rem.otl.core.duo.messages.Message}'s to the Server, queues up the message to be sent after previous messages have been sent.
	 * @param message - {@link com.rem.otl.core.duo.messages.Message} to be sent to the Server.
	 */
	...
	/**
	 * Sends a special "{@link com.rem.otl.core.duo.messages.PassMessage}" which causes the Server to relay the {@link com.rem.otl.core.duo.messages.Message} to the partnered {@link com.rem.otl.core.duo.client.Client} if there is such a client.
	 * If there is no partner, the {@link com.rem.otl.core.duo.messages.Message} is ignored.
	 * @param message - {@link com.rem.otl.core.duo.messages.Message} to be sent to the partner client.
	 */
	...
	private class HandlerOutputThread extends Thread{
		/**
		 * Continually sends outgoing {@link com.rem.otl.core.duo.messages.Message}s while the Handler is connected
		 */
		@Override
		public void run(){
			try {
	...
	/**
	 * Sets the games object, this allows correspondence between the {@link com.rem.otl.core.game.menu.JoinMenu} interface and the handler.
	 ...
	 * this will result in 
	 * 	- the {@link com.rem.otl.core.game.menu.HostMenu} resuming to wait for someone to join
	 * and
	 * 	- the {@link com.rem.otl.core.game.menu.JoinMenu} returning to look at available games.
	 */
	public void kick() {
	 ...
	 * @return This Handler's {@link com.rem.otl.core.game.hero.Hero}.
	 */
	public Hero getHero(){
	...
	/**
	 * Allows the {@link com.rem.otl.core.game.Game} to set this handler's hero.
	 * @param hero - {@link com.rem.otl.core.game.hero.Hero} to be controlled by this handler.
	 */
	 ...
	 * @param menu - The {@link com.rem.otl.core.game.menu.IDuoMenu Menu} for this handler to control.
	 */
	...
	/**
	 * Allows the relavent {@link com.rem.otl.core.duo.messages.Message}'s to interact with the controlling {@link com.rem.otl.core.game.menu.IDuoMenu Menu}.
	 * @return - This Handler's controlling {@link com.rem.otl.core.game.menu.IDuoMenu Menu}.
	 */
