 ...
 * In this way new games are presented to potential partners to join the game, using {@link com.rem.otl.core.duo.messages.JoinGameMessage}.
 * @author Geoffrey
 *
 */
public class AddGameMessage extends Message{
	...
	/**
	 * Empty method because the only receivers of this {@link com.rem.otl.core.duo.messages.Message} are Servers.
	 */
	@Override
