...
/**
 * Sent after a {@link com.rem.otl.core.game.Game} has ended, this {@link com.rem.otl.core.duo.messages.Message} asks the {@link com.rem.otl.core.game.menu.TransitionMenu} the game was completed in the "best" time. If so, save the game times (date and time it took to complete/fail).
...
public class SaveGameMessage extends Message {
	...
	/**
	 * Initializes this {@link com.rem.otl.core.duo.messages.Message} with the necessary variables.
