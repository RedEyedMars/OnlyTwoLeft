...
import com.rem.otl.core.editor.field.BooleanOnClickFieldComponent;
import com.rem.otl.core.editor.field.FieldEditor;
import com.rem.otl.core.editor.field.FloatFieldComponent;
import com.rem.otl.core.editor.field.OnClickFieldComponent;
import com.rem.otl.core.editor.field.TextFieldComponent;
import com.rem.otl.core.editor.program.ProgramSquareEditor;
...
public abstract class Editor extends GraphicView {
	...
	private void addFileToAction(OnStepAction action){
		...
		action.setTarget(Hub.map.setNextMap(file.getPath()));
	}
