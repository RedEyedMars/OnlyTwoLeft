...
public class OnCreateSquareEditor extends Editor{
	...
	protected void saveCurrent(){
		Storage.saveText(Hub.manager.createOutputStream(saveTo.getPath()), writer.getText());
	}
	...
	protected void saveAndReturn() {
		...
		ints.add(Hub.map.getIntCoordinate(square_x,com.rem.otl.core.game.environment.Map.X_axis));
		ints.add(Hub.map.getIntCoordinate(square_y,com.rem.otl.core.game.environment.Map.Y_axis));
		ints.add(Hub.map.getIntCoordinate(square_w,com.rem.otl.core.game.environment.Map.X_axis));
		ints.add(Hub.map.getIntCoordinate(square_h,com.rem.otl.core.game.environment.Map.Y_axis));
