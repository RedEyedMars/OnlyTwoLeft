 ...
 */
public class GLFont {
	public static Color myColour = new Color(120,170,250);
	public static Color theirColour = new Color(120,130,200);
	...
	public void print(int x, int y, String msg)
	{
		if (msg != null) {
			...
			GLApp.pushAttribOrtho();
			{
				...
				GLApp.setOrthoOn();
				// draw the text
				GL11.glTranslatef(x, y, 1);        // Position The Text (in pixel coords)
